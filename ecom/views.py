...
def games(request):
    return render(request, "ecom/games.html")

def tictactoe_view(request):
    return render(request, "ecom/TicTacToe.html")

def GuessGame_view(request):
    return render(request, "ecom/GuessGame.html")

def rps_view(request):
    return render(request, "ecom/rps.html")
